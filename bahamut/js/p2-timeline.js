...
var items = new vis.DataSet([
    ...
    {content: '救赎之翼', start: moment('03:30', 'HH:mm'), subgroup:2, group: 2},
    {content: '救赎之翼', start: moment('03:33', 'HH:mm'), subgroup:2, group: 2},
...
var items = new vis.DataSet([
    ...
    {content: '救赎之翼', start: moment('03:59', 'HH:mm'), subgroup:3, group: 2},
    {content: '救赎之翼', start: moment('04:02', 'HH:mm'), subgroup:3, group: 2},
    {content: '救赎之翼', start: moment('04:05', 'HH:mm'), subgroup:3, group: 2},
...
var items = new vis.DataSet([
    ...
    {content: '救赎之翼', start: moment('04:36', 'HH:mm'), subgroup:2, group: 2},
    {content: '救赎之翼', start: moment('04:39', 'HH:mm'), subgroup:2, group: 2},
    {content: '救赎之翼', start: moment('04:42', 'HH:mm'), subgroup:2, group: 2},
